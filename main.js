...
const CourseManagement = () =>{
  ...
  return [addCourse, deleteCourse, updateCourse, getCourseById, getCourseByName, getAllCourse]
}

const [addCourse, deleteCourse, updateCourse, getCourseById, getCourseByName, getAllCourse] = CourseManagement()
